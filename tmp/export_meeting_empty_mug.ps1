...
$stairSource = [System.Drawing.Bitmap]::new('C:\Users\望兴腾\.codex\generated_images\01a0ad86-844a-7e50-9b5e-4843c923a4c1\exec-f88ac0b9-02f1-4dbe-95eb-1311bf81c61d.png')
...
if ($right -lt 0) { throw 'No opaque mug pixels found.' }
...
$target = Join-Path (Get-Location) 'Assets\AIGC Source\Building\Object\Meeting Room\meeting_mug_white_empty_topdown_64x64.png'
