...
$stairSource = [System.Drawing.Bitmap]::new('C:\Users\望兴腾\.codex\generated_images\01a0ad86-844a-7e50-9b5e-4843c923a4c1\exec-6f562f17-4f97-4bae-8c71-61abd616b76c.png')
...
if ($right -lt 0) { throw 'No opaque computer pixels found.' }
...
$target = Join-Path (Get-Location) 'Assets\AIGC Source\Building\Object\Office\office_computer_broken_topdown_64x64.png'
