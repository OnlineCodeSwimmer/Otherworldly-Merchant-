...
$stairSource = [System.Drawing.Bitmap]::new('C:\Users\望兴腾\.codex\generated_images\01a0ad86-844a-7e50-9b5e-4843c923a4c1\exec-f1571cca-4f76-4cdb-9275-20afb75f972d.png')
...
if ($right -lt 0) { throw 'No opaque tea table pixels found.' }
...
$target = Join-Path (Get-Location) 'Assets\AIGC Source\Building\Object\Meeting Room\meeting_tea_table_topdown_128x64.png'
