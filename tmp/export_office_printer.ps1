...
$stairSource = [System.Drawing.Bitmap]::new('C:\Users\望兴腾\.codex\generated_images\01a0ad86-844a-7e50-9b5e-4843c923a4c1\exec-026b19d8-b6fd-460e-9494-ed387e2e4c87.png')
...
if ($right -lt 0) { throw 'No opaque printer pixels found.' }
...
$target = Join-Path (Get-Location) 'Assets\AIGC Source\Building\Object\Office\office_printer_topdown_64x64.png'
