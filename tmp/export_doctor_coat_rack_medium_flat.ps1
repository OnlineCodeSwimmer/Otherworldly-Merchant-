...
$stairSource = [System.Drawing.Bitmap]::new('C:\Users\望兴腾\.codex\generated_images\01a0ad86-844a-7e50-9b5e-4843c923a4c1\exec-3ad242d0-3454-4d38-81b6-5ec6a9fe84c0.png')
...
$target = Join-Path (Get-Location) 'Assets\AIGC Source\Building\Object\clinic_doctor_coat_rack_medium_flat_topdown_64x96.png'
